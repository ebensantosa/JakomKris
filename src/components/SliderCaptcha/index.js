...
import './slider-captcha.scss'
import $ from 'jquery'

export class SliderCaptcha extends Component {
    ...
    componentDidMount() {
        ...
        SliderCaptcha.DEFAULTS = {
            width: canvasWidth, //Ukuran Canvas
            height: canvasHeight, //
            PI: Math.PI,
            sliderL: 42,    // 滑块边长
            sliderR: 9,     // 滑块半径
        ...
        var sliderCaptcha = Plugin;
        sliderCaptcha.Constructor = SliderCaptcha;
        ...
        var handleVerifyCaptcha = this.handleVerifyCaptcha
        var handleYetVerify = this.handleYetVerify
        ...
        var captcha = sliderCaptcha({
            ...
            onSuccess: function () {
                ...
                handleYetVerify(true)
                handleVerifyCaptcha(true)
            },
        });
    }

    handleVerifyCaptcha = (value) => {
        this.props.onVerifyCaptcha(value)
    }

    handleYetVerify = (value) => {
        this.props.onYetVerify(value)
    }

    render() {
        let { isYetVerify } = this.props
        return (
            <div className="slider-captcha">
                <div class="container-fluid">
                    <div class="form-row">
                        <div class="col-12">
                            <div class={"slidercaptcha "+(isYetVerify ? '' : 'invalid')+" card"}>
                                ...
                                <div class="card-body">
                                    <div id="captcha"></div>
                                    {!isYetVerify ?
                                        <p className="font-normal font-10 color-red mt-3 mb-0">Pelase verify that your are not a robot</p>
                                    :
                                        null
                                    }
                                </div>
